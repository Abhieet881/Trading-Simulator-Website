...
import { TrendingUp, Mail, AlertCircle, ArrowLeft, Send } from 'lucide-react';
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-[420px] bg-white rounded-2xl border border-[#E5E7EB] shadow-[0_4px_20px_rgba(0,0,0,0.02)] p-8">
        {success ? (
          <div className="text-center flex flex-col items-center">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-[#111111] mb-3">Reset link sent</h2>
          ...
          <>
            <div className="mb-6 text-center">
              ...
              <p className="text-sm text-[#6B7280] mt-1">We'll send you a link to reset your password</p>
            </div>
